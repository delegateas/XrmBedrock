declare namespace Form.ctx_transaction.Main {
  namespace Information {
    namespace Tabs {
    }
    interface Attributes extends Xrm.AttributeCollectionBase {
      get(name: "ctx_enddate"): Xrm.DateAttribute;
      get(name: "ctx_invoice"): Xrm.LookupAttribute<"ctx_invoice">;
      get(name: "ctx_name"): Xrm.Attribute<string>;
      get(name: "ctx_startdate"): Xrm.DateAttribute;
      get(name: "ctx_subscription"): Xrm.LookupAttribute<"ctx_subscription">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "ctx_invoice"): Xrm.LookupControl<"ctx_invoice">;
      get(name: "ctx_name"): Xrm.StringControl;
      get(name: "ctx_startdate"): Xrm.DateControl;
      get(name: "ctx_subscription"): Xrm.LookupControl<"ctx_subscription">;
