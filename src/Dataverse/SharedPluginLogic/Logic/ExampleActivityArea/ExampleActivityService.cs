...
namespace Dataverse.PluginLogic.ExampleActivityArea;

public class ExampleActivityService // Missing an interface here? We actually do not need one as this IS exactly the logic we want to test, so exchanging the implementation for _this_ services does no make sense
{
    private readonly IPluginExecutionContext context;
    private readonly ILogger logger;

    public ExampleActivityService(
    ...
    public void ExampleValidateTaskIsWithinBusinessHours()
    {
