declare namespace Form.ctx_invoice.Main {
  namespace Information {
    namespace Tabs {
    }
    interface Attributes extends Xrm.AttributeCollectionBase {
      get(name: "ctx_invoicenumber"): Xrm.Attribute<string>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      get(name: "ctx_invoicenumber"): Xrm.StringControl;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls,Information.QuickViewForms> {
    getAttribute(attributeName: "ctx_invoicenumber"): Xrm.Attribute<string>;
    getAttribute(attributeName: "ownerid"): Xrm.LookupAttribute<"systemuser" | "team">;
    getAttribute(attributeName: string): undefined;
    getAttribute(delegateFunction: Xrm.Collection.MatchingDelegate<Xrm.Attribute<any>>): Xrm.Attribute<any>[];
    getControl(controlName: "ctx_invoicenumber"): Xrm.StringControl;
